print('Добрый день, Вы зашли в программу которая поможет высчитать площадь и периметр прямоугольника, начнем:') # Добавил приветствие и пояснения, что бы программа выглядела более дружелюбно.
